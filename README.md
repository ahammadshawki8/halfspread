...
**Measured at 2026-09-11T19:29:33+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 2.33% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (6.1x worse) |
| Same contract, open against latest | 22.14x more expensive to cross  (SPY 763 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $322.00 |
| Entry cost paid | $44.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $6.00 |
| Account | $474.01 against a $100,000 start |
| Candidates priced / admitted | 95,894 / 2,258 |
| Decisions not to trade | 257 |
