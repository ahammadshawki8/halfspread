...
**Measured at 2026-09-11T17:58:29+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 2.13% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (6.7x worse) |
| Same contract, open against latest | 13.18x more expensive to cross  (SPY 762 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $322.00 |
| Entry cost paid | $44.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $12.00 |
| Account | $547.51 against a $100,000 start |
| Candidates priced / admitted | 90,796 / 2,168 |
| Decisions not to trade | 251 |
