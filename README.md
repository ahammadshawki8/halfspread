...
**Measured at 2026-09-16T18:02:51+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 2.86% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (5.0x worse) |
| Same contract, open against latest | 0.09x more expensive to cross  (SPY 760 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $417.00 |
| Entry cost paid | $54.00 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $21.00 |
| Account | $26.64 against a $100,000 start |
| Candidates priced / admitted | 118,430 / 2,930 |
| Decisions not to trade | 402 |
