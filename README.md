...
**Measured at 2026-09-11T17:07:53+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 2.04% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (7.0x worse) |
| Same contract, open against latest | not yet measured |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $291.00 |
| Entry cost paid | $41.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $9.00 |
| Account | $527.16 against a $100,000 start |
| Candidates priced / admitted | 86,946 / 2,109 |
| Decisions not to trade | 249 |
| Sessions behind the breach distribution | 668 since 2024-01-02 |
| Claims reproducing from the journal | 9/10 |
