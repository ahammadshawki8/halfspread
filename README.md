...
**Measured at 2026-09-14T19:30:39+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 2.56% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (5.6x worse) |
| Same contract, open against latest | 4.09x more expensive to cross  (SPY 760 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $374.00 |
| Entry cost paid | $48.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $11.00 |
| Account | $183.69 against a $100,000 start |
| Candidates priced / admitted | 101,263 / 2,372 |
| Decisions not to trade | 261 |
