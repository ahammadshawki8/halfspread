...
**Measured at 2026-09-09T19:16:25+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 1.75% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (8.1x worse) |
| Same contract, open against latest | 7.63x more expensive to cross  (SPY 762 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $237.00 |
| Entry cost paid | $35.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $11.00 |
| Account | $128.99 against a $100,000 start |
| Candidates priced / admitted | 69,276 / 1,546 |
| Decisions not to trade | 178 |
