...
**Measured at 2026-09-08T17:33:53+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 1.70% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (8.4x worse) |
| Same contract, open against latest | 19.33x more expensive to cross  (SPY 762 put) |
| Largest decision-to-execution drift | $8.00 per contract |
| Credit received | $154.00 |
| Entry cost paid | $24.00 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $14.00 |
| Account | $113.47 against a $100,000 start |
| Candidates priced / admitted | 50,982 / 1,160 |
| Decisions not to trade | 47 |
