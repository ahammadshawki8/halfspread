...
**Measured at 2026-09-10T17:37:50+00:00.** Every figure below is generated from the
...
| Same contract, open against latest | 0.05x more expensive to cross  (SPY 760 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $291.00 |
| Entry cost paid | $41.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $18.00 |
| Account | $-285.60 against a $100,000 start |
| Candidates priced / admitted | 75,216 / 1,726 |
| Decisions not to trade | 223 |
