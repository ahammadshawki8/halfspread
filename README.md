...
**Measured at 2026-09-09T19:46:54+00:00.** Every figure below is generated from the
...
| | |
|---|---|
| Cost to cross at the money, SPY | 1.82% of mid |
| Cost to cross 2 to 3 points out | 14.29% of mid  (7.9x worse) |
| Same contract, open against latest | 1.29x more expensive to cross  (SPY 760 put) |
| Largest decision-to-execution drift | $13.00 per contract |
| Credit received | $237.00 |
| Entry cost paid | $35.50 |
| Exit cost paid | $0.00 |
| Exit cost still at stake, open positions | $13.50 |
| Account | $112.96 against a $100,000 start |
| Candidates priced / admitted | 72,002 / 1,645 |
| Decisions not to trade | 209 |
